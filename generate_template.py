...
def generate(accent, output_path, headline="celebrate"):
    ...
    # "The colleagues of Codestar hereby celebrate" (anniversary)
    # "The colleagues of Codestar hereby confer upon" (honorary)
    draw_mixed_centered(
        c,
        W / 2,
        696,
...
generate(BLUE, "assets/template.pdf", headline="celebrate")
generate(RED, "assets/template_honorary.pdf", headline="confer upon")
